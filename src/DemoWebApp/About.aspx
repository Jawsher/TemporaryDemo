...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ObjectDataSource ID="StudentDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllStudents" TypeName="BackEnd.BLL.MyStudentController">
    ...
    <asp:ObjectDataSource ID="CourseDataSource" runat="server" DataObjectTypeName="BackEnd.Entities.Course" DeleteMethod="RemoveCourse" InsertMethod="AddCourse" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllCourses" TypeName="BackEnd.BLL.CourseController" UpdateMethod="UpdateCourse"></asp:ObjectDataSource>
</asp:Content>
